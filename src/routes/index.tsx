...
// Header component adapted for Tanstack Router
const HeroHeader = () => {
...
// App component for the demo section
const AppComponent = () => {
    return (
        <div className="relative space-y-3 rounded-[1rem] bg-white/5 p-4">
            ...
            <div className="space-y-3">
                <div className="text-foreground border-b border-white/10 pb-3 text-sm font-medium">This month, you're studying more consistently than last month.</div>
                <div className="space-y-3">
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-foreground align-baseline text-xl font-medium">8.5</span>
                    ...
                    <div className="space-y-1">
                        <div className="space-x-1">
                            <span className="text-foreground align-baseline text-xl font-medium">5.2</span>
                            <span className="text-muted-foreground text-xs">Hours/week</span>
                        </div>
                    ...
                    <div className="relative mx-auto max-w-6xl px-6 pb-20 pt-32 lg:pt-48">
                        <div className="relative z-10 mx-auto max-w-4xl text-center">
                            ...
                            <TextEffect
                                ...
                                Transform your learning experience with AI-powered study tools, collaborative features, and intelligent scheduling that adapts to your learning style.
                            </TextEffect>
